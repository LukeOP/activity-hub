...
const lessonsRoutes = [
  {path: 'lessons', name: 'Lessons', meta: { title: 'Lessons'},
      children: [
        ...
        { path: ':id', name: 'LessonDetails', component: LessonDetails, props: true, meta: { title: 'Lesson Details'}, children: [
      ...
      { path: 'attendance', name: 'LessonAttendance', children: [
        { path: 'overview', name: 'LessonAttendanceOverview', component: LessonAttendanceOverview, props: true, meta: { title: 'Attendance Overview'} },
        { path: ':id', name: 'LessonAttendanceSingle', component: LessonAttendanceSingle, props: true, meta: { title: 'Lesson Attendance'} },
      ] },
  ]},
] 
