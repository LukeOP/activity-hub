    ...
    <form @submit.prevent="assignLesson">
      ...
      <div class="row">
        ...
        <div class="col col-12 col-md-6 mb-5">
          ...
          <button class="btn btn-primary form-control mt-4" :disabled="!formCompleted">Assign Lesson To Tutor</button>
        </div>
...
function assignLesson(){
  console.log(reviewedLessonData.value);
  console.log(reviewedContactData.value);
  // Create new lesson
