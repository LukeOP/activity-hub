...
<div>
  ...
  <div class="btn btn-outline-grey form-control mt-2 mb-5" id="clear-btn" @click="clearFilter">Reset Filter</div>
  ...
  <div>
    ...
    <button class="btn btn-primary form-control mb-2" @click="quickOption('this month')">This Month</button>
    <button class="btn btn-primary form-control mb-2" @click="quickOption('this year')">This Year</button>
  </div>
</div>
...
function quickOption(option){
  ...
  if(option === 'this month') {filtering.value.start_date = formatDate(moment().startOf('month')); filtering.value.end_date = formatDate(moment())}
  if(option === 'this year') {filtering.value.start_date = formatDate(moment().startOf('year')); filtering.value.end_date = formatDate(moment())}
  returnFiltered()
}
